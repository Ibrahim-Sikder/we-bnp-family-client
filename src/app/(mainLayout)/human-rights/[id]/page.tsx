...
const HumanRightsDetail = () => {
  const { id } = useParams();

  const post = humanRights.find((item) => item.id === Number(id));
        ...
        <div className="lg:flex md:flex gap-10 my-16">
          <div className="h-full w-full">
            ...
            <div className="p-5">
              ...
              <p className="text-justify mt-3">{post.description}</p>
            </div>
            ...
            <div className="p-5 bg-gray-100 mx-5 rounded mt-5 ">
              ...
              <p className="mt-3">
                কারাগারে নির্যাতনের শিকার ব্যক্তিদের কষ্টের কথা বলে শেষ করা যায়
                না।
              </p>
            </div>
...
export default HumanRightsDetail;
