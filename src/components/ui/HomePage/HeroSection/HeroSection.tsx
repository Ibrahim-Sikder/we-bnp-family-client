                                        ...
                                        <div className={`sliderWraps fade-in ${index === 1 ? 'secondSlide' : ''} ${index === 2 ? 'thirdSlide' : ''}`} >
                                            <div className={`heroContent ${fadeOut ? 'fade-out zoom-out' : ''}`}>
                                                <div className="spacey-y-1 md:space-y-5">
                                                    <h1 className='capitalize text-[15px] md:text-[20px] lg:text-[50px] w-[850px] font-bold leading-[7px]  lg:leading-[70px]'>{language === 'ENG' ? slide.eng_name : slide.bng_name}</h1>
                                                ...
                                                <Button sx={btnStyle}>{language === 'ENG' ? 'Join Us' : 'যোগ দিন'} <ArrowForwardIos sx={{ fontSize: { md: '15px', sm: '10px', xs: '10px' } }} /> </Button>
                                            </div>
