...
const ImageGallery = () => {
  const gallery = [
    ...
    { id: 3, image: img4, date: "08-22-2024", title: "ফেনীতে বন্যার্তদের পাশে ‘আমরা বিএনপি পরিবার" },
    { id: 3, image: img5, date: "08-22-2024", title: "ফেনীতে বন্যার্তদের পাশে ‘আমরা বিএনপি পরিবার" },
    { id: 3, image: img6, date: "08-22-2024", title: "ফেনীতে বন্যার্তদের পাশে ‘আমরা বিএনপি পরিবার" },
    { id: 3, image: img7, date: "08-22-2024", title: "ফেনীতে বন্যার্তদের পাশে ‘আমরা বিএনপি পরিবার" },
  ];
