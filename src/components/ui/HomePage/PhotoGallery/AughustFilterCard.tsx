...
interface PrisonCardProps {
    augostilterData: TPrison[];
    language: string,
}



const AughustFilterCard: React.FC<PrisonCardProps> = ({ augostilterData, language }: PrisonCardProps) => {
    ...
    return (
        <>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                {augostilterData?.map((data: TPrison, index: number) => (
...
export default AughustFilterCard;